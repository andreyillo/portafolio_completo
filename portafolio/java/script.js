// AÑADIR CLASE ACTIVA PARA ENLACE HACER CLIC
...
for (let i = 0; i < navLi.length; i++) {
    ...
    // DESLIZA LA SECCIÓN DE CONTENIDO EN LINK CLICK
 ...
 // DESPLAZAMIENTO SUAVE DE LA PAGINA
  if (window.innerWidth < 850) {
  ...
  // EFECTO TEXTO
  // Matriz de texto
  const dataText = ["2142329.", "Tecnologo", "Analisis Y Desarrollo De Sistema De Informacion"];
  ...
  function typeWriter(text, i, fnCallback) {
    if (i < (text.length)) {
      ...
      // ESTABLECER RETARDO ANTES DEL SIGUIENTE CARÁCTER
      setTimeout(function() {
